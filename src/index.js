...
const mandelbrot = (c, location, content) => {
  return figure(() =>
    marginNote(() =>
      ...
      article(() =>
        ...
        section(() =>
          ...
          p(() => newThought(() => 'These are images') + ' of the space of complex numbers,' +
            marginNote(() => `i.e. values of the form \\(a + i b\\)
          ...
          section(() =>
            ...
            mandelbrot(
              ...
              '-0.19854 + i 1.10018',
              () => `Here we zoom in \\(250\\times\\) into a smaller copy of the beetle that's attached
            ...
            mandelbrot(
              ...
              '0.28439 - i 0.01359',
              () => 'Here we looking at a \\(1,000\\times\\) magnification of a swirling area on the positive real buttocks of the beetle, with many small beetles floating around.') +
            mandelbrot(
              '0.28443044026692704_-0.012731933593750003_0.0009765625_1000000',
              '0.28443 - i 0.01273',
              () => 'This is close by the above image at the same  \\(1000\\times\\) magnification, focussing on a spiral and a whirlpool.') +
            mandelbrot(
              '-0.7961858113606771_-0.18322652180989607_0.0009765625_100000',
              '-0.79619 - i 0.18323',
              () => 'This beautiful and delicate \\(1,000\\times\\) magnified structure is in the neck (the gap between the main cardioid and the large circle).') +
            mandelbrot(
              '-0.748985544840495_0.05576807657877601_0.000244140625_100000',
              '-0.748986 + i 0.055768',
              () => 'Zooming in more to \\(4000\\times\\) magnification deep in neck shows a kind of lacework alongside a spiral.') +
            mandelbrot(
              '-0.6584480285644533_-0.4668521881103515_0.000244140625_100000',
              '-0.658448 - i 0.466852',
              () => `Also at \\(4,000\\times\\) magnification, on the shoulder of the beetle is this
                   snowflake-like pattern`) +
            mandelbrot(
              '-0.7151815414428709_-0.23002815246582042_0.0001220703125_100000',
              '-0.715181 - i 0.230028',
              () => `Higher up on the shoulder at \\(8,000\\times\\) magnification we find these two spirals
            ...
            mandelbrot(
              ...
              '0.148865892 + i 0.642407724',
              () => `And now at \\(2,000,000\\times\\) magnification we first zoom into the hips
            ...
            mandelbrot(
              ...
              '-0.596360941 + i 0.662749640',
              () => `Here. magnified a bot more than \\(2,000,000\\times\\) we have zoomed into a
          ...
          to reveal this interesting patchwork, and unusual asymmetric distorted beetle`) +
            mandelbrot(
              ...
              '0.250006',
              () => `Now we are at more than \\(8,000,000\\times\\) magnification
            ...
            mandelbrot(
              ...
              '0.37001085814 + i 0.67143543269',
              () => `This beetle in a radiating crown at \\(17,000,000\\times\\) magnification
                  is embedded in a filament off the main beetle's hips`) +
            mandelbrot(
              '-1.9999117501972556_0_7.450580596923828e-9_1000000',
              '-1.99991175020',
              () => `And now we are down at \\(130,000,000\\times\\) magnification at
            ...
            mandelbrot(
              ...
              '-0.999208533756 + i 0.302364353482',
            ...
            mandelbrot(
              ...
              '-1.67440967428 + i 0.00004716557',
              () => `We're now at \\(1,000,000,000\\times\\) (billion times!) magnification
            ...
            mandelbrot(
              ...
              '-0.139975337339 - i 0.992076239092',
              () => `Here we are deep (\\(2,000,000,000\\times\\)) within a filament off the main body
                  passing several levels of beetle as we zoom down.`) +
            mandelbrot(
              '-0.7499888023860679_0.006997251233593751_2.5e-10_1000000',
              '-0.749988802386 + i 0.006997251234',
              () => `Here we are at \\(4,000,000,000\\times\\) magnification in the narrow
            crack of the neck where we see this decorative square.`) +
            mandelbrot(
              '0.43245668411436744_-0.34053226446030754_2e-10_100000',
              '0.432456684114 - i 0.340532264460',
              () => `Now we are at \\(5,000,000,000\\times\\) magnification and off
                   the buttocks we find this lovely rosette.`) +
            mandelbrot(
              '-0.18271806444477842_0.6614075685543184_1.4551915228366852e-11_100000',
              '-0.1827180644448 + i 0.6614075685543',
              () => `Now we are at \\(70,000,000,000\\times\\) magnification  in the
            ...
            mandelbrot(
              ...
              '-0.59636078463178 + i 0.66274965378928',
            ...
            mandelbrot(
              ...
              '-1.76853740279050 + i 0.00054004950144',
              () => `Here we go deep \\(1,000,000,000,000\\times\\) (trillion!) magnification) into the neck of a small
            ...
            mandelbrot(
              ...
              '-0.743643887037159 + i 0.131825904205312',
              () => `Here we are at \\(1,000,000,000,000\\times\\) magnification
            ...
            mandelbrot(
              ...
              '-1.6744096746527182 + i 0.000047165698790702304',
              () => `Here we go \\(2,000,000,000,000\\times\\) magnification) into the
            ...
            mandelbrot(
              ...
              '-0.16089413126577512 + i 1.0376191282366105',
          ...
          through a succession of spirals till we reach \\(2,000,000,000,000\\times\\) magnification.`) +
            mandelbrot(
              ...
              '-0.7345612674879727 + i 0.3601896136089664',
              () => `This linear feature at \\(2,000,000,000,000\\times\\) magnification is
            ...
            mandelbrot(
              ...
              '-1.6744096746527197 + i 0.0000471656987933374',
