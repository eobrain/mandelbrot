      ...
      article()(
        ...
        section()(
          ...
          p()(
            ...
            i('z') + '←' + i('z') + '²+' + i('c') + ' starting at ' + i('z') + '=0 the value of |' + i('z') +
            '| stays less than 2. The colored areas surrounding the black of the Mandelbrot set are values of ' +
            i('c') + ' for which ' + i('z') + ' eventually goes to infinity, with the colors indicating how many iterations until |' + i('z') +
            '|>2') +
          ...
          to reveal this interesting patchwork, and unusual asymmetric distorted beetle`) +
            ...
            very close to the asymptotic ` + i('z') + '=¼ point of the cardioid') +
            mandelbrot(
